    ...
    <div className="bg-lightGray text-black text-base h-screen">
      <div className="mx-auto max-w-screen-sm">
        <div className="flex flex-col items-center">
          ...
          <div className="h-[20-vh] justify-center items-center">
            <Link
              to="/"
              className="flex justify-center items-center mt-2 text-primary "
            >
              <BackArrow size={20} className="mr-1"></BackArrow>
              <p className="mt-[2px] text-medium">Back</p>
            </Link>
          </div>
        </div>
      </div>
